...
WEI = 5;     %connection strength from e. to i. cells 3.5
WEE = 4;       %connection strength from e. cell to self 3
WII = -4;      %connection strength from i. cell to self
WIE = -5;    %connection strength from i. to e cells
